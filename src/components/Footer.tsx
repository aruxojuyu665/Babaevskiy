      ...
      <div className="mx-auto max-w-6xl px-4 py-12 md:px-8 md:py-16">
            ...
            <nav className="flex flex-col">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="flex min-h-[44px] items-center text-sm opacity-70 transition-opacity hover:opacity-100"
                >
                  {link.label}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex min-h-[44px] items-center text-lg font-semibold transition-opacity hover:opacity-80"
              >
                {BUSINESS.phone}
              </a>
              ...
              <a
                ...
                className="mt-3 inline-flex min-h-[44px] items-center gap-2 py-2 text-sm opacity-70 transition-opacity hover:opacity-100"
              >
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-center text-xs opacity-40">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex min-h-[44px] items-center px-2 underline underline-offset-2 transition-opacity hover:opacity-70"
          >
            Создано студией братьев Белялетдиновых
          </a>
        </div>
      </div>
    </footer>
